                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.blog',$blog->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_title" class="form-control" type="text" value="{{ $blog->blog_title }}"  id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_tags" class="form-control" type="text" value="{{ $blog->blog_tags }}" data-role="tagsinput"  id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
